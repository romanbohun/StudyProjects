...
class AddLocationViewController: UIViewController {
    ...
    private var viewModel: AddLocationViewViewModel!
    ...
    override func viewDidLoad() {
        ...
        let searchBarDirver = searchBar.rx.text.orEmpty.asDriver()
        viewModel = AddLocationViewViewModel(query: searchBarDirver, locationService: GeocoderService())
